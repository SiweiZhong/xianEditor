...
function whereAmI(words, location) {
  ...
  if (words.length == 0) {
    ...
    loc--;
    x++;
    if (words[loc] instanceof Enter$1) {
...
var Text$1 = function (_Placeholder) {
  inherits(Text, _Placeholder);

  function Text(value) {
    classCallCheck(this, Text);

    var _this3 = possibleConstructorReturn(this, (Text.__proto__ || Object.getPrototypeOf(Text)).call(this));
...
var Space$1 = function (_Text) {
  ...
  function Space() {
    ...
    var _this4 = possibleConstructorReturn(this, (Space.__proto__ || Object.getPrototypeOf(Space)).call(this));
...
var Tab$1 = function (_Text2) {
  ...
  function Tab() {
    ...
    var _this5 = possibleConstructorReturn(this, (Tab.__proto__ || Object.getPrototypeOf(Tab)).call(this));

    _this5.value = '&nbsp&nbsp&nbsp&nbsp';
    _this5.real = '\x20\x20\x20\x20';
    return _this5;
  }
...
var Enter$1 = function (_Text3) {
  ...
  function Enter() {
    ...
    var _this6 = possibleConstructorReturn(this, (Enter.__proto__ || Object.getPrototypeOf(Enter)).call(this));
...
var Group$1 = function (_Identifier3) {
  inherits(Group, _Identifier3);

  function Group() {
    var style = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    classCallCheck(this, Group);

    var _this7 = possibleConstructorReturn(this, (Group.__proto__ || Object.getPrototypeOf(Group)).call(this));
...
var MathTag$1 = function (_Group) {
  ...
  function MathTag() {
    ...
    var _this8 = possibleConstructorReturn(this, (MathTag.__proto__ || Object.getPrototypeOf(MathTag)).call(this));

    _this8.name = 'span';
    _this8.attrs = attrs;
    _this8.style = Object.assign({}, mathTag);
...
function updateWordsProps$$1(location) {
  ...
  while (location <= tree$1.words.length) {
    ...
    if (tree$1.words[location - 2] instanceof Enter$2) {
...
function addWord(key) {
  ...
  updateWordsProps$$1(tree.editorState.location);
}



function addMath() {
  var start = new MathTag$1({ class: "math_tag" });

  store.dispatch(addKey(new Text$1('$')));
  ...
  updateWordsProps$$1(tree.editorState.location - 2);
}

function addEnter() {
  var word = new Enter$1();
...
function moveUp$1() {
  ...
  var i = loc > 0 ? loc - 1 : 0;
  for (; i >= 0; i--) {
    if (tree$2.words[i] instanceof Style$3) {
      loc--;
      continue;
    }
...
var Style$4 = Style$1;
var Group$2 = Group$1;
var Placeholder$4 = Placeholder$1;
...
function delBackspace() {
  while (1) {
    ...
    if (word instanceof Placeholder$4) {
      ...
      if ((word instanceof Style$4 || word instanceof Group$2) && word.header) {
        //遇到空的样式节点就删除
        if (word.header === last) {
          store.dispatch(backspace());
        ...
        if (tree$3.words[tree$3.editorState.location - 1] instanceof Placeholder$4) {
          break;
        }
      } else {
        break;
  ...
  updateWordsProps$$1(tree$3.editorState.location);
}
...
var App = { _scopeId: 'data-v-04c2046b',
  ...
  render: function render(h) {
    ...
    console.log(this._words.map(function (w) {
      return w.value ? w.value + '=>' + w.rowNum + '-' + w.width : undefined;
    }));
